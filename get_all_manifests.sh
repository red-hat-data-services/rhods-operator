...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["codeflare"]="red-hat-data-services:codeflare-operator:rhoai-2.24:config"
    ["ray"]="red-hat-data-services:kuberay:rhoai-2.24:ray-operator/config"
    ["trustyai"]="red-hat-data-services:trustyai-service-operator:rhoai-2.24:config"
    ["modelregistry"]="red-hat-data-services:model-registry-operator:rhoai-2.24:config"
    ["trainingoperator"]="red-hat-data-services:training-operator:rhoai-2.24:manifests"
    ["datasciencepipelines"]="red-hat-data-services:data-science-pipelines-operator:rhoai-2.24:config"
    ["modelcontroller"]="red-hat-data-services:odh-model-controller:rhoai-2.24:config"
    ["feastoperator"]="red-hat-data-services:feast:rhoai-2.24:infra/feast-operator/config"
    ["llamastackoperator"]="red-hat-data-services:llama-stack-k8s-operator:rhoai-2.24:config"
)
